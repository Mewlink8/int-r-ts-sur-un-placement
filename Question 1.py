#calculate the capital and interest obtained after 8 years of investment with a rate of 2.3% net per year considering the calculation of interest once a YEAR
def c(n):
    if n==0:
        return c0
    else:
